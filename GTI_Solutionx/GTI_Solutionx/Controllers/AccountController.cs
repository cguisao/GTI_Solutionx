...
namespace GTI_Solutionx.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            ILogger<AccountController> logger, IServiceProvider serviceProvider)
        {
        ...
        private async Task CreateUserRoles(string email, string userType)
        {
            ...
            if (!roleCheck)
            {
                ...
                roleResult = await RoleManager.CreateAsync(new IdentityRole(userType));
            }
